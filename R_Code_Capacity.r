...
capacity_constraint_num[1] =  capacity_constraint_num[1]*(1+(0.01)*0)
for (i in 1:2) {
...
total_cost_1 = get.objective(lps.model)
total_cost_1
...
reduced_cost_for_camden = senstvt_constraint_1$duals[1]
reduced_cost_for_camden
lower_bound_for_camden = senstvt_constraint_1$dualsfrom[1]
lower_bound_for_camden
upper_bound_for_camden = senstvt_constraint_1$dualstill[1]
upper_bound_for_camden
...
# Plant capacity
capacity_constraint_num = as.numeric(capacity_constraint[,2])
capacity_constraint_num[1] =  capacity_constraint_num[1]*(1+(0.01)*a)
for (i in 1:2) {
  add.constraint(lps.model, plant_allocation[i,], "<=", capacity_constraint_num[i])
}
